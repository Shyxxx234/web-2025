...
function isPrimeNumber(number) {
    ...
    if (typeof (number) == 'number' || (typeof (number) == 'object' && Object.keys(number).length != 0)) {
        for (elt of number) {
        ...
        console.log("Входной тип не соотвествует типу number или object, или переданные данные являются пустым объектом")
    }
}
